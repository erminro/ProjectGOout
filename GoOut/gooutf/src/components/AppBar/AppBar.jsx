      ...
      <AppBar position="static" style={{textAlign: 'center',display: "flex", }} color="custom">
        <Toolbar>
          ...
          <Drawer anchor='left' open={isDrawerOpen} onClose={()=>setIsDrawerOpen(false)} >
            ...
            <Button href={logg? "http://localhost:3000/your_events":"http://localhost:3000/login"} variant="text" color="custom" style={{height:"55px",width:"250px"}}><ModeEditIcon/>Edit events</Button>
